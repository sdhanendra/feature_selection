...
data = pandas.read_csv("../data/uci-wine-quality-dataset/winequality-data.csv")
...
soln = pandas.read_csv("../data/uci-wine-quality-dataset/winequality-solution-input.csv")
